...
export const SHOWCASE_DESIGN: ShowcaseDesign[] = [
  ...
  { id: "restauration-03", style: "food héros + personne", composition: "cuisinier ou client photographié en train de servir/manger le ramen, bol en héros, badge promo, prix dominant", palette: ["#1C1917", "#F59E0B", "#F8FAFC"], paletteWhy: "sombre chaleureux pour faire briller le plat", ambiance: "gourmand", typography: "display titre + chiffres prix", rules: RULES },
  ...
  { id: "mode-03", style: "doux poudré + mannequin", composition: "une personne réelle qui porte et tient les pièces, boutique, pas une grille produits seule", palette: ["#F9E4E8", "#FFFFFF", "#9D174D"], paletteWhy: "rose poudré beauté/mode", ambiance: "délicat", typography: "script léger + sans", rules: RULES },
