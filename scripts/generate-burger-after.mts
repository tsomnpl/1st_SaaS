...
const PROMPT = [
  ...
  "SETTING: a real restaurant dining room behind the person — tables, warm lamps, bokeh, not a red void and not a dark empty kitchen.",
  "PERSON: photoreal West or Central African WAITER / serveur, dressed as a waiter:",
  "white dress shirt, black waistcoat or black apron, tidy, looking toward the camera. Natural skin and hands. Not a hoodie, not a chef jacket.",
  "FOOD: a gourmet burger served on a WIDE SHALLOW WHITE PLATE (assiette / bol plat) in the FOREGROUND at the BOTTOM.",
  "The ENTIRE burger is visible: top bun, patty, cheese, lettuce, bottom bun. Nothing covers it. Hands hold the plate rim only, never the burger.",
  "The plate is large enough to read the whole burger at a glance. No tiny bowl that hides the bun.",
